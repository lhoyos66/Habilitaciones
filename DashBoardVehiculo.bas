Attribute VB_Name = "DashBoardVehiculo"
Sub EjecutarVehiculoResumen()
    ...
    Set wsDashboard = ThisWorkbook.Sheets("VEHICULO RESUMEN")
    ...
    Call GenerarResumenVehiculo(proyecto, Empresa, ServicioOPuesto, placa)
End Sub
Sub EjecutarGenerarDashboardVehiculo()
    Dim wsDashboard As Worksheet
    Dim proyecto As String
    Dim Empresa As String
    ...
    Set wsDashboard = ThisWorkbook.Sheets("DASHBOARD VEHICULO")
    ...
    ' Llamar a la macro principal con los parámetros obtenidos
    Call GenerarDashboardVehiculo(proyecto, 1, Empresa, Servicio, placa)
End Sub



Sub CopiarDatosAFilaActivaVehiculo()
    ...
    Set rngActiva = Intersect(ActiveCell, wsDashboard.ListObjects("DashboardVehiculo").DataBodyRange)
    On Error GoTo 0
    
    If rngActiva Is Nothing Then
        MsgBox "Seleccione una celda dentro de la tabla DashboardVehiculo.", vbExclamation
        Exit Sub
    End If
    
    ' Obtener la fila activa de la tabla DashboardPersonal
    Set filaActiva = wsDashboard.ListObjects("DashboardVehiculo").ListRows(rngActiva.Row - wsDashboard.ListObjects("DashboardVehiculo").HeaderRowRange.Row)
...
Function EvaluarVigenciaVehiculo(vigencia As Date) As String
    Dim wsDashboard As Worksheet
    ...
    If diasDiferencia >= diasMargen Then
        EvaluarVigenciaVehiculo = "Vigente"
    ElseIf diasDiferencia > 1 And diasDiferencia < diasMargen Then
        EvaluarVigenciaVehiculo = "Por Vencer"
    Else
        EvaluarVigenciaVehiculo = "Vencido"
    End If
End Function


Sub ActualizarVigenciaDiasVehiculo(rngActiva As Range)
    Dim wsDashboard As Worksheet
    Dim filaActiva As ListRow
    Dim vigencia As Date
...
Sub GenerarDashboardVehiculo(proyecto As String, TipoRep As Long, Optional Empresa As String = "", Optional Servicio As String = "", Optional placa As String = "")
    ...
    ' Limpiar la tabla DashboardVehiculo
    On Error Resume Next
    wsDashboard.ListObjects("DashboardVehiculo").DataBodyRange.Delete
    On Error GoTo 0
    ...
    For Each subCarpeta In carpetaProyecto.SubFolders
        ...
        For Each subSubCarpeta In subCarpeta.SubFolders
            ...
            Set fila = wsDashboard.ListObjects("DashboardVehiculo").ListRows.Add
            ...
            If vehiculoDict.exists(placaVehiculo) Then
                ...
                fila.Range(1, 14).Value = vehiculoInfo(4) ' ESTADO RECURSO
...
Sub GenerarResumenVehiculo(proyecto As String, Optional Empresa As String = "", Optional ServicioOPuesto As String = "", Optional placa As String = "")
    Application.ScreenUpdating = False
    Application.Calculation = xlCalculationManual
    ...
    Set wsVehiculoResumen = ThisWorkbook.Sheets("VEHICULO RESUMEN")

    ' Limpiar la tabla PersonalResumen
    On Error Resume Next
    wsVehiculoResumen.ListObjects("VehiculoResumen").DataBodyRange.Delete
    On Error GoTo 0
    ...
    Dim rutaProyecto As String
    Dim rutaRecurso As String
    rutaProyecto = rutaBase & "\" & wsVehiculoResumen.Range("C2").Value & "\HABILITACIONES\VEHICULOS"
    rutaRecurso = rutaBase & "\RECURSOS\VEHICULOS"
    ...
    For Each subCarpeta In carpetaProyecto.SubFolders
        ...
        If vehiculoDict.exists(dniPersonal) Then
            ...
            If (Empresa <> "" And Empresa <> vehiculoInfo(2)) Or (ServicioOPuesto <> "" And ServicioOPuesto <> vehiculoInfo(1)) Or (vehiculoInfo(1) = "EMBARCACIÓN") Then
                GoTo NextPLACA
            End If
            ...
            Set fila = wsVehiculoResumen.ListObjects("VehiculoResumen").ListRows.Add
            fila.Range(1, 1).Value = proyecto
            fila.Range(1, 2).Value = vehiculoInfo(2) ' Empresa
...
Sub ActivaResumenVehiculo()
    ' Activar la hoja "VEHICULO RESUMEN"
    ThisWorkbook.Sheets("VEHICULO RESUMEN").Activate
End Sub

Sub DashBoardVehiculoDesdeResumen()
    ...
    Set wsPersonalResumen = ThisWorkbook.Sheets("VEHICULO RESUMEN")
    Set wsDashboard = ThisWorkbook.Sheets("DASHBOARD VEHICULO")
    
    Set tblPersonalResumen = wsPersonalResumen.ListObjects("VehiculoResumen")
    ...
    If Not Intersect(ActiveCell, tblPersonalResumen.DataBodyRange) Is Nothing Then
        ...
        Call GenerarDashboardVehiculo(proyecto, 2, Empresa, ServicioOPuesto, DNI)
    Else
